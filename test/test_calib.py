...
d=flap.get_data('MAST_BES',exp_id=48235,name='BES*',options={'Resample':1e5},coordinates={'Time':[0.82,0.84]})
...
# plt.title('Total signal during calibration')
...
# plt.figure(figsize=(8,8))
# d = flap.get_data('MAST_BES',exp_id=48235,name='BES*',coordinates={'Time':[0.332,0.336]})
# d.data /= d_cal.data
# d.plot(plot_type='grid xy',axes=['Column','Row','Time'])
# plt.suptitle('48235 BES Calibrated')

# plt.figure(figsize=(5,5))
# d.plot(summing={'Time':'Sum'},axes=['Column','Row'],plot_type='image')
# plt.title('48235 mean calibrated BES (0.332-0.336)')
